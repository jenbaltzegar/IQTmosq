...
kdrHaps <- ggplot(data = freqAll_long[!is.na(freqAll_long$Frequency),], aes(x=year, y=Frequency)) +
  ...
  annotate("rect", xmin = 1999.0, xmax = 2001.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="gray") + # No pyrethroids
  annotate("rect", xmin = 2001.5, xmax = 2014.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="orange") + # Pyrethroids
