...
# Remove any samples collected from the south of the city
kdrData <- kdrData[kdrData$Y >= '9583180',] 
...
write.csv(mc.1016.moyr, file = "/Users/jenbaltz/Dropbox/GouldLab/Project_Mosquito/Database/mc.1016.MoYr_reduced_byMonth_noSouth.csv", row.names = F)
write.csv(mc.1534.moyr, file = "/Users/jenbaltz/Dropbox/GouldLab/Project_Mosquito/Database/mc.1534.MoYr_reduced_byMonth_noSouth.csv", row.names = F)
...
temp2 <- kdrData[kdrData$newDate >= "2002-10-01" & kdrData$newDate <= "2002-10-31",]
temp2
nrow(temp2)
temp2 <- temp2[, c(1:2, 11:13, 25:26, 28)]
