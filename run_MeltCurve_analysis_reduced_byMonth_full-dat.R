...
# load data 
kdrData <- read.csv('kdrData_reduced_2020-05-27.csv')
...
write.csv(mc.1016.moyr, file = "/Users/jenbaltz/Dropbox/GouldLab/Project_Mosquito/Database/mc.1016.MoYr_reduced_byMonth_full-dat.csv", row.names = F)
write.csv(mc.1534.moyr, file = "/Users/jenbaltz/Dropbox/GouldLab/Project_Mosquito/Database/mc.1534.MoYr_reduced_byMonth_full-dat.csv", row.names = F)
