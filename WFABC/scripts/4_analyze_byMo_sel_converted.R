...
# Load data ----
post_s.1016 <- unlist(read.table("converted_V1016I_byMo_sel_posterior_s.txt"))
post_h.1016 <- unlist(read.table("converted_V1016I_byMo_sel_posterior_h.txt"))
post_s.1534 <- unlist(read.table("converted_F1534C_byMo_sel_posterior_s.txt"))
post_h.1534 <- unlist(read.table("converted_F1534C_byMo_sel_posterior_h.txt"))
...
# post_s.1534 -----
boxplot_s.1534 <- ggplot(post.1534, aes(y=s, x='')) +
  geom_boxplot() +
