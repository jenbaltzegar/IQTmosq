...
# df
write.csv(df, "./results/byYr/converted/posteriorMeans_converted.csv")

# Plot Posteriors for Selection
png("./results/byYr/converted/plot_converted_posterior_s_1016_byMo_sel.png")
plot(density(t(post_s.1016)), lwd=2, main="Posteriors for Selection \n Ile1016 under selection", xlab="s")
dev.off()

png("./results/byYr/converted/plot_converted_posterior_s_1534_byMo_sel.png")
...
png("./results/byYr/converted/plot_converted_posterior_h_1016_byMo_sel.png")
plot(density(t(post_h.1016)), lwd=2 ,main="Posteriors for Dominance \n Ile1016 under selection", xlab="h")
dev.off()

png("./results/byYr/converted/plot_converted_posterior_h_1534_byMo_sel.png")
...
# Save plots
png("./results/byYr/converted/plot_converted_2D_1016_byMo_sel.png")
image(z_1016, xlab="Selection Coefficient", ylab="Dominance", main="Ile1016 under selection"
      # , xlim = c(-1,1), ylim = c(0,1)
      )
dev.off()

png("./results/byYr/converted/plot_converted_2D_1534_byMo_sel.png")
...
boxplot_s.1534
ggsave("./results/byYr/converted/plot_converted_boxplot_s.1534.png", dpi = 600)
...
boxplot_s.1016 <- ggplot(post_s.1016, aes("", V1)) +
  ...
  theme(plot.title = element_text(hjust = 0.5)) 
boxplot_s.1016
ggsave("./results/byYr/converted/plot_converted_boxplot_s.1016.png", dpi = 600)
...
boxplot_h.1534 <- ggplot(post_h.1534, aes("", V1)) +
  ...
  theme(plot.title = element_text(hjust = 0.5)) 
boxplot_h.1534
ggsave("./results/byYr/converted/plot_converted_boxplot_h.1534.png", dpi = 600)
...
boxplot_h.1016 <- ggplot(post_h.1016, aes("", V1)) +
  ...
  theme(plot.title = element_text(hjust = 0.5)) 
boxplot_h.1016
ggsave("./results/byYr/converted/plot_converted_boxplot_h.1016.png", dpi = 600)

# Tiling the plots -----
boxplot_tile <- grid.arrange(boxplot_s.1016, boxplot_h.1016, boxplot_s.1534, boxplot_h.1534, nrow = 2)
ggsave(plot = boxplot_tile, "./results/byYr/converted/plot_converted_boxplot_tiled.png")
