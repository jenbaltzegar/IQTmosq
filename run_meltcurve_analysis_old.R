...
# For 1016 locus at all years - requires function_mc.1016.R
...
# For 1534 locus at all years - requires function_mc.1534.R
...
# For 410 locus at all years - requires function_mc.410.R
...
df14.1016 <- rbind(mJan14, mFeb14, mMar14, mApr14, mMay14, mJun14, mJul14, mAug14, mSep14, mOct14)
# Add year ID to rows in df rename
mc.1016.mo14 <- cbind(month, df14.1016)
...
df14.1534 <- rbind(sJan14, sFeb14, sMar14, sApr14, sMay14, sJun14, sJul14, sAug14, sSep14, sOct14)
# Add year ID to rows in df rename
mc.1534.mo14 <- cbind(month, df14.1534)
...
# For 1016 locus
df1016.byMo <- rbind(mJan00, mFeb00, mMar00, mApr00, mMay00, mJun00, mJul00, mAug00, mSep00, mOct00, mNov00, mDec00
...
# Add year ID to rows in df rename
mc.1016.byMo <- cbind(MonthYear, df1016.byMo)

# For 1534 locus
df1534.byMo <- rbind(sJan00, sFeb00, sMar00, sApr00, sMay00, sJun00, sJul00, sAug00, sSep00, sOct00, sNov00, sDec00
...
# Add year ID to rows in df rename
mc.1534.byMo <- cbind(MonthYear, df1534.byMo)
