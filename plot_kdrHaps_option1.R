...
kdrHaps <- ggplot(data = freqAll_long[!is.na(freqAll_long$Frequency),], aes(x=year, y=Frequency)) +
  ...
  annotate("rect", xmin = 1999.0, xmax = 2001.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="grey") + # No pyrethroids
  annotate("rect", xmin = 2001.5, xmax = 2007.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="red") + # Delatmethrin 2002 - 2007
  annotate("rect", xmin = 2007.5, xmax = 2008.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="orange") + # Cypermethrin 2008
  annotate("rect", xmin = 2008.5, xmax = 2011.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="yellow") + # a-Cypermethrin 2009 - 2011
  annotate("rect", xmin = 2011.5, xmax = 2012.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="green") + # Cypermethrin & a-Cypermethrin 2012
  annotate("rect", xmin = 2012.5, xmax = 2013.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="blue") + # Lambda, a-Cypermethrin, Cypermethrin, & a-Cypermethrin+pyriporx 2013
  annotate("rect", xmin = 2013.5, xmax = 2014.5, ymin = -Inf, ymax = Inf, alpha=0.2, fill="orange") + # Cypermethrin 2014
  annotate("rect", xmin = 2014.5, xmax = 2018.0, ymin = -Inf, ymax = Inf, alpha=0.2, fill="gray") + # No pyrethroids
  
  ### Add text to represent type of insecticides used
  annotate("text", x= 2008, y=1.1, label = "Pyrethroids", size = 5, fontface = 2) +
  ...
  annotate("text", x=2012, y=1.05, label= "Alpha & \n Cyper", size = 4) +
  annotate("text", x=2013, y=1.05, label= "Multiple*", size = 4) +
  annotate("text", x=2014, y=1.05, label = "Cyper", size = 4) +
  annotate("text", x=2016, y=1.1, label = "No \n Pyrethroids", size = 5, fontface = 2) +
